...
(function () {
  ...
  const EN = {
    ...
    "s2.d": "Proper dismantling of kitchens for a move, renovation or rebuild.",
    ...
    "s9.note": "License being obtained",
    ...
    "w1.t": "Modern kitchen with compact worktop",
    "w1.l": "Berlin",
    ...
    "w3.t": "IKEA kitchen with solid wood worktop",
    "w3.l": "Berlin",
    "w3.d": "Installation of an IKEA kitchen with solid wood worktop, black granite sink and a fully integrated dishwasher. Precise worktop fitting and professional installation of all kitchen elements.",
    "w4.t": "Connection of hob & oven",
    "w4.l": "Berlin",
    "w4.d": "Correct electrical connection of hob and oven as part of the kitchen installation.",
    "w5.t": "Custom built-in wardrobe to the customer's specs",
    "w5.l": "Berlin",
    "w5.d": "Custom built-in wardrobe made to the customer's individual measurements. Professional assembly with drawers, shelving and optimal use of the hallway space.",
    ...
    "w8.t": "Preparing for the furniture assembly",
    "w8.l": "Berlin-Charlottenburg",
    "w8.d": "Careful preparation of the work area before assembly begins. Floors were covered with cardboard for protection and the workspace organised to ensure clean, safe and professional furniture assembly.",
    "w9.t": "5-metre IKEA corner wardrobe",
    "w9.l": "Berlin",
    "w9.d": "Professional assembly of a 5-metre IKEA corner wardrobe with mirror and drawers. Despite a floor slope of about 2 cm, the wardrobe was aligned exactly and fitted perfectly to the room.",
    ...
    "w12.t": "Fully equipped assembly service",
    "w12.l": "Berlin & Brandenburg",
    "w12.d": "A professionally equipped assembly service with a fully organised tool and machine system — so most jobs can be done quickly, cleanly and efficiently on the very first visit.",
    "w13.t": "Service vehicle",
    "w13.l": "Berlin & Brandenburg",
    "w13.d": "Fully equipped for fast and efficient on-site jobs.",
    ...
    "rsum.meta": "4.9 from 105 reviews · 96% five stars",
